...
var proto_username = process.env.PROTO_USERNAME
var proto_password = process.env.PROTO_PASSWORD
...
if (env === 'production' && useAuth === 'true') {
 app.use(utils.basicAuth(username, password, proto_username, proto_password))
}
