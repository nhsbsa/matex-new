 ...
 * @param   {string}   password_one Expected password
 * @param   {string}   password_two Expected password
 * @returns {function} Express 4 middleware requiring the given credentials
 */

exports.basicAuth = function (username, password_one, password_two) {
  return function (req, res, next) {
    ...
    if (!user || user.name !== username || user.pass_one !== password_one || user.pass_two !== password_two) {
